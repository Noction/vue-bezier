...
import { h } from 'vue'
import DissolveListTransition from '@/components/Dissolve/DissolveListTransition.vue'

describe('components / Dissolve / DissolveListTransition', () => {
  ...
  it('should apply correct CSS variables', () => {
    ...
    expect(style).toContain('--noc-transition-leave-duration: 500ms')
    expect(style).toContain('--noc-transition-enter-delay: 80ms')
    expect(style).toContain('--noc-transition-leave-delay: 160ms')
  })
