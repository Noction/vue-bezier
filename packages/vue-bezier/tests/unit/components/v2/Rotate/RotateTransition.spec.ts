...
import RotateTransition from '../../../../../src/components/v2/Rotate/RotateTransition.vue'

describe('components / v2 / Rotate / RotateTransition', () => {
  it('should render with default props', () => {
    const wrapper = mount(RotateTransition)
