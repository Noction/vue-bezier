    ...
    >
      <template v-for="item in items" :key="item">
        ...
        >
          ...
          >
            <div
              class="size-10 flex justify-center scale-0 opacity-0 rounded-full bg-current shadow transition group-hover:shadow-current group-hover:scale-100 group-hover:opacity-100 dark:bg-sky-100"
            >
