...
<template>
  <div class="min-h-screen antialiased bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">
    ...
    <div class="flex items-center min-h-screen xl:max-w-5xl max-w-none mx-auto px-4 sm:px-6 md:px-8 relative">
      <div class="border border-slate-200 dark:border-slate-700 rounded-lg w-full h-125 grid grid-rows-[auto_1fr] grid-cols-[200px_1fr_200px] xl:grid-cols-[200px_1fr_400px] gap-y-4 overflow-hidden">
        <nav class="col-span-3 xl:col-span-3 flex w-full justify-center gap-x-8 font-semibold text-slate-600 dark:text-slate-300">
          <router-link
            to="/"
